...
/**
  ...
  */
uint32_t md_calc_sqrt(uint32_t data)
{
...
/**
  ...
  */
uint32_t md_calc_div(uint32_t dividend, uint32_t divisor, uint32_t *remainder)
{
...
/**
  ...
  * @retval The result of division.
  */
int32_t md_calc_div_sign(int32_t dividend, int32_t divisor, int32_t *remainder)
{
...
/**
  ...
  */
flag_status_t md_calc_get_dz_status(void)
{
